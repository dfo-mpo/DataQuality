...
class Accessibility:
    ...
    def s1_metric(self):  
        ...
        # log the results
        utils.log_score(test_name = "Accessibility (S1)", dataset_name = utils.get_dataset_name(self.dataset_path), score = accessibility_score) 
