...
""" Class to manage and run all metrics for the Uniqueness dimension. 
...
"""
class Uniqueness:
    # Finds and loads all metric names defined in the uniqueness folder
    ...
    def __init__(self, dataset_path, return_type="score", logging_path=None, uploaded_file_name=None, metric_params=None):
        ...
        # Looks for all metric classes in the uniqueness folder
        self.ALL_METRICS = self.search_metrics() 

    """ Automatically finds and loads all metric classes defined in the uniqueness folder.
    """
        ...
        if set(metrics).issubset(set(self.ALL_METRICS)):
            ...
            for metric in metrics:
                ...
                try:
                    ...
                    uniqueness_score, metric_log_csv = metric_instance.run_metric()
