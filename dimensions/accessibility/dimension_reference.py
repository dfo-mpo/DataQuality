...
""" Class to manage and run all metrics for the Accessibility dimension.
...
"""
class Accessibility:
    # Finds and loads all metric names defined in the accessibility folder
    ...
    def __init__(self, dataset_path, return_type="score", logging_path=None, uploaded_file_name=None, metric_params=None):
        ...
        # Looks for all metric classes in the accessibility folder
        self.ALL_METRICS = self.search_metrics() 

    """ Automatically finds and loads all metric classes defined in the accessibility folder.
    """
    ...
    """ Run metrics: Will run specified metrics or all accessibility metrics by default. return_logs returns the logging data so the UI can visualize test output details.
    """
        ...
        if set(metrics).issubset(set(self.ALL_METRICS)):
            ...
            for metric in metrics:
                ...
                try:
                    ...
                    accessibility_score, metric_log_csv = metric_instance.run_metric()
