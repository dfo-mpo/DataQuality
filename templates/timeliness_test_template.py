...
TEST = "T#" # Replace "T#" with the test name, e.g., "T1"

""" Class to represent an individual test for the Timeliness dimension.
    Serves as a template for creating a new Timeliness test.
...
def create_metadata():
    ...
    t#_metadata = TestMetadata(dimension, TEST)
    ...
    # TODO: Replace "t#" with the test name, e.g., "t1"
    return t#_metadata 